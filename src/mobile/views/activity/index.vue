...
const lists = ref([
  ...
  {
    imgUrl: '/src/assets/images/home_activity/2.png',
    title: '西湖论剑安全特训营',
    content:
  ...
  {
    imgUrl: '/src/assets/images/home_activity/3.png',
    title: '新品发布',
    content: '',
  },
  {
    imgUrl: '/src/assets/images/home_activity/4.png',
    title: '第二直播间',
    content:
  ...
  {
    imgUrl: '/src/assets/images/home_activity/6.png',
    title: '西湖论剑十周年回顾',
    content:
