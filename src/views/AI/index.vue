  ...
  <div class="common-layout">
    ...
    <el-form-item label="大会类型">
      <el-checkbox-group v-model="form.type">
        <el-checkbox value="网络安全" name="type">
          网络安全
        </el-checkbox>
        <el-checkbox value="人工智能" name="type">
          人工智能
        </el-checkbox>
        <el-checkbox value="物联网" name="type">
          物联网
        </el-checkbox>
        <el-checkbox value="金融" name="type">
          金融
        </el-checkbox>
    ...
    <el-form-item>
            ...
            <el-button class="create-button" type="primary" @click="onSubmit">生成内容</el-button></div>
    </el-form-item>
    </el-form>
      </el-aside>
      <el-main>
...
let userStore = useUserStore();
  ...
  const hid = ()=>{
    ...
    const regions = ['上海', '北京', '广州', '深圳', '杭州', '成都', '天津', '重庆', '武汉', '西安', '长沙', '青岛', '大连', '苏州']
    const ws = ref();
    ...
    const onSubmit = () => {
      sendmessage.value = '写一份大会的宣传文案:' + form.date1+"到"+form.date2+",大会名称"+form.name +",大会区域"+ form.region + ",大会类型"+form.type + ",大会描述"+form.description
    ...
    .container {
      z-index: 2;
        ...
        &::after {
            ...
            height: 100%;
            width: .375rem;
            background-color: rgba(#0091ff,.04);
