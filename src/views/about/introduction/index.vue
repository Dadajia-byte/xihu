...
.video-container{
  ...
  .video-description{
    background:  linear-gradient(rgba(255, 255, 255, 1), rgba(255, 255, 255, 0.5)), url(https://images.pexels.com/photos/20453947/pexels-photo-20453947.jpeg?auto=compress&cs=tinysrgb&w=600&lazy=load) ;
    ...
    top: 0;
    z-index: 1;
    box-shadow: .2125rem .2125rem .2125rem #D5D5D5;
