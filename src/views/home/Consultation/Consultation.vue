...
const newsList = ref([
  {
    imageUrl:
      '/src/assets/images/home_news/2.jpg',
  ...
  {
    imageUrl:
      '/src/assets/images/home_news/1.png',
  ...
  {
    imageUrl:
    '/src/assets/images/home_news/4.jpg',
  ...
  },
  {
    ...
    content: '人民网杭州4月19日电 （叶宾得）今天，西湖论剑暨安恒信息首次年度新品发布会在杭州举行，发布会以“新·见未来 实·现梦想”为主题，介绍安恒“MSS+数据安全”两大战略新进展、发布新产品...',
  },
])
</script>
...
.main {
  ...
  .bg{
    ...
    top: -1.25rem;
    right:0;
    background: url('/src/assets/images/bg_images/homebg1.png') no-repeat center/cover;
